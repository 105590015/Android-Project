    ...
    private AdapterView.OnItemClickListener gridViewOnItemClick = new
            AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent,
                    ...
                    alpha_out.setDuration( 2500 );
                    ScaleAnimation scale_in = new ScaleAnimation(0, 1, 0, 1);
                    scale_in.setDuration(2500);
                    scale_in.setStartOffset(2500);
                    ScaleAnimation scale_out = new ScaleAnimation(1, 0, 1, 0);
                    scale_out.setDuration(2500);
                    Animation rotate_in = new RotateAnimation(0, 360, 500, 300);
                    rotate_in.setDuration(2500);
                    rotate_in.setStartOffset(2500);
                    Animation rotate_out = new RotateAnimation(0, 360, 500, 300);
                    rotate_out.setDuration(2500);
                    Animation trans_in = new TranslateAnimation(0, 0, 300, 0);
                    trans_in.setDuration(2500);
                    Animation trans_out = new TranslateAnimation(0, 0, 0, -300);
                    trans_out.setDuration(2500);
